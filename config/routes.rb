SampleApp::Application.routes.draw do
  ...
  match '/nagrudnyj-dospekh/bron', to: 'static_pages#body_armour', via: 'get'
  match '/nagrudnyj-dospekh/uklonenie', to: 'static_pages#body_evasion', via: 'get'
  match '/nagrudnyj-dospekh/ehnergeticheskij-shchit', to: 'static_pages#body_armour_es', via: 'get'
  match '/nagrudnyj-dospekh/bron-ehnergeticheskij-shchit', to: 'static_pages#body_armour_es_bron', via: 'get'
  match '/nagrudnyj-dospekh/bron-uklonenie', to: 'static_pages#body_armour_bron_ev', via: 'get'
  match '/nagrudnyj-dospekh/ehnergeticheskij-shchit-uklonenie', to: 'static_pages#body_armour_es_uklonenie', via: 'get'
  match '/nagrudnyj-dospekh/zhertvennoe-oblachenie', to: 'static_pages#body_armour_zhertvennoe_oblachenie', via: 'get'
end